<template>
  <div class="p-grid">
    <div class="p-col">
      <Fieldset>
        <template #legend> Meet the Team </template>
        <Card class="profile-card">
          ...
          <template #content>
            <p>
              <i>
                I like to take things apart and put them back together! I love language and logic, and am excited by
                challenges that force me to think in new ways to overcome them. Computers fascinate me, and I want to be
                a part of a future where the union of technology and linguistics enables programs to understand and
                accomplish things nobody could ever have imagined. As such, I continue to focus my efforts on working at
                the forefront of the artificial intelligence, machine learning, and natural language processing fields,
                as I firmly believe that such technologies will pave the way for a new tomorrow!
              </i>
            </p>
          </template>
          <template #footer>
            <ul>
              <li>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  v-tooltip.bottom="'Wren on GitHub'"
                >
                  <svg id="github-circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                    <path
