...
<template>
  <ul>
    <li>
      ...
      <a href="https://twitter.com/wrencode" target="_blank" rel="noopener" v-tooltip.bottom="'Wrencode on Twitter'">
        <svg
          class="social-media-icon"
          id="twitter-square"
          viewBox="0 0 448 512"
